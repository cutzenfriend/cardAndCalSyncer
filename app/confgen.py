...
def generate(cfg: dict[str, Any], *, only_pair: str | None = None,
    ...
    def _is_readonly(sname: str) -> bool:
        # one-way direction freezes the source side; never both (vdirsyncer
        # raises BothReadOnly if both sides are read-only).
        return sname in frozen and sname not in writable
